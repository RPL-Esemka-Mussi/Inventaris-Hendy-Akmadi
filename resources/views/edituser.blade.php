        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown ms-3-md fw-bolder">
    ...
    <div class="container">
        <div class="row mt-5 justify-content-center">
            <div class="col-6 mt-4">
                <h3 class="fw-bold text-center fs-2 mt-4">Update User</h3>
                <form action="{{ url('user/update') }}" method="post">
                    ...
                    <div class="form-gruop mt-5 fw-bold">
                        ...
                        <input value="{{ $user->name }}" type="text" name="name" id="name" class="form-control" placeholder="Nama">
                    </div>
                    ...
                    <div class="form-gruop mt-3 fw-bold">
                        ...
                        <input value="{{ $user->level }}" type="text" name="level" id="level" class="form-control" placeholder="Level">
                    </div>

                    <div class="form-gruop mt-3 fw-bold">
                        <label for="alamat">Alamat</label>
                        <input value="{{ $user->alamat }}" type="text" name="alamat" id="alamat" class="form-control" placeholder="Alamat">
                    </div>

                    <div class="form-gruop mt-3 fw-bold">
                        <label for="telepon">Telepon</label>
                        <input value="{{ $user->telepon }}" type="text" name="telepon" id="telepon" class="form-control" placeholder="Telepon">
                    </div>
                    <div class="mt-3 float-end mb-4">
